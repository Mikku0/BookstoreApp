        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Employee_Salary = table.Column<decimal>(type: "TEXT", nullable: true),
                    Employee_DateOfEmployment = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Employee_CartId = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Users_Carts_Employee_CartId",
                        column: x => x.Employee_CartId,
                        principalTable: "Carts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Deliveries_Users_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "Id", "Author", "Genre", "Name", "Price", "WarehouseId" },
                values: new object[,]
                {
                    { 1, "Adam Mickiewicz", "Klasyka", "Pan Tadeusz", 29.99m, null },
                    { 2, "Andrzej Sapkowski", "Fantasy", "Wiedźmin", 34.99m, null },
                    { 3, "Stanisław Lem", "Science Fiction", "Solaris", 27.50m, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_Employee_CartId",
                table: "Users",
                column: "Employee_CartId");
